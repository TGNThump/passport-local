...
describe('Strategy', function() {
  ...
  describe('handling a request with only a username', function() {
    var strategy = new Strategy({username: 'johndoe'}, function(username, password, done) {
      throw new Error('should not be called');
    });
  ...
  describe('handling a request with only a password', function() {
    var strategy = new Strategy({password: 'secret'}, function(username, password, done) {
      throw new Error('should not be called');
    });
